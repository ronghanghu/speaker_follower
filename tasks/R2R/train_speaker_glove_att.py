...
def get_model_prefix(args, image_feature_list):
    ...
    model_prefix = 'panorama_glove_att_speaker_{}_{}'.format(feedback_method, image_feature_name)
...
def make_env_and_models(args, train_vocab_path, train_splits, test_splits, test_instruction_limit=None):
    setup()
    ...
    decoder = try_cuda(SpeakerDecoderLSTM(len(vocab), word_embedding_size, hidden_size, dropout_ratio, glove=glove, use_input_att_feed=True))
